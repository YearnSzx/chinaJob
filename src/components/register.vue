<template>
  <div id="register">
    ...
    <div class="register" :class="{register2:changeCNorEN2 == 'false'}">
        ...
        <div class="choice">
            <span :class="{active:show == 1}" @click="teachShow()">{{teachReg.imTeach}}</span>
            <span :class="{active:show == 2}" @click="jigouShow()">{{teachReg.imJigou}}</span>
        </div>
        <div class="form" v-show="jigou">
            <el-form :model="jigouData" label-width="115px" ref="jigouData" :rules="rules2()" label-position="left">
                <div class="must deepCss">
                    <el-form-item :label="teachReg.JPNumber" prop="jigouPhoneNumber">
                        <el-input v-model="jigouData.jigouPhoneNumber" auto-complete="off" clearable></el-input>
                    </el-form-item>
                    <div class="mustRight">{{teachReg.tRightTip}}</div>
                </div>
                 <div class="deepCss">
                    <el-form-item :label="teachReg.JYanZhengMa"  prop="jigouYanZhengMa" >
                        <el-input v-model="jigouData.jigouYanZhengMa" auto-complete="off" maxlength="6" clearable>
                            <template slot="append"></template>
                            <el-button slot="append" :disabled = phoneYZM @click="sendYzm">{{teachReg.getYzm}}
                ...
                <div class="must deepCss">
                    <el-form-item :label="teachReg.JPassWord"  prop="jigouPassWord">
                        <el-input v-model="jigouData.jigouPassWord" auto-complete="off" clearable></el-input>
                    </el-form-item>
        ...
        <div class="form2" v-show="teach">
            <el-form :model="teachData" label-width="115px" ref="teachData" :rules="rule2()" label-position="left">
                <div class="must deepCss">
                    <el-form-item :label="teachReg.tPNumber" prop="tPhoneNubmer">
                        <el-input v-model="teachData.tPhoneNubmer" auto-complete="off" clearable></el-input>
                    </el-form-item>
                    <div class="mustTop">
                        <p>{{teachReg.tTopTip}}</p>
                        <p :class="{tTopTip2:changeCNorEN2 == 'false'}">{{teachReg.tTopTip2}}</p>
                    </div>
                    <div class="mustRight">{{teachReg.tRightTip}}</div>
                </div>
                <div class="deepCss">
                    <el-form-item :label="teachReg.tEmail"  prop="tEmail">
                        <el-input v-model="teachData.tEmail" auto-complete="off" clearable></el-input>
                    </el-form-item>
                </div>
                <div class="deepCss">
                    <el-form-item label="WhatAPP"  prop="tWhatAPP">
                        <el-input v-model="teachData.tWhatAPP" auto-complete="off" clearable></el-input>
                    </el-form-item>
                </div>
                <div class="deepCss">
                    <el-form-item label="Facebook"  prop="tFacebook">
                        <el-input v-model="teachData.tFacebook" auto-complete="off" clearable></el-input>
                    </el-form-item>
                </div>
                <div class="deepCss">
                    <el-form-item label="Wechat"  prop="tWechat">
                        <el-input v-model="teachData.tWechat" auto-complete="off" clearable></el-input>
                    </el-form-item>
                </div>
                <div class="deepCss">
                    <el-form-item label="Skype"  prop="tSkype">
                        <el-input v-model="teachData.tSkype" auto-complete="off" clearable></el-input>
                    </el-form-item>
                </div>
                <div class="must deepCss">
                    <el-form-item :label="teachReg.tPassWord"  prop="tPassWord">
                        <el-input v-model="teachData.tPassWord" auto-complete="off" clearable></el-input>
                    </el-form-item>
                    <div class="mustBottom">{{teachReg.tBottomTip}}</div>
                    <div class="mustRight">{{teachReg.tRightTip}}</div>
                </div>
        ...
        <el-button class="submit" ref="submit" @click="zhuCe" :disabled="submitShow">{{teachReg.registerZH}}</el-button>
        <p class="xieyi">{{teachReg.lastTip}}<strong @click="toServiceA">{{teachReg.fwxy}}</strong></p>
        <div class="close">
