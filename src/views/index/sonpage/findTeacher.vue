      ...
      <div class="jobChoice">
        ...
        >
          ...
          <div class="btn">
            ...
            <span :class="{ active: show4 == null }" @click="column4(null)">{{
              choiceBtnCN.All
            }}</span>
          </div>
          <div class="btn">
            ...
            <span :class="{ active: show2 == 1 }" @click="column2(1)">{{
              choiceBtnCN.NativeCountries
            }}</span>
            <span :class="{ active: show3 == 1 }" @click="column3(1)">{{
              choiceBtnCN.Male
            }}</span>
            <span :class="{ active: show4 == 1 }" @click="column4(1)">{{
              choiceBtnCN.HoldWorkpermit
            }}</span>
          </div>
          <div class="btn">
            ...
            <span :class="{ active: show4 == 2 }" @click="column4(2)">{{
              choiceBtnCN.NewApplicant
            }}</span>
          </div>
        </div>
      </div>
