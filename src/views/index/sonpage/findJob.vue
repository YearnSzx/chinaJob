  ...
  <div id="banner">
    ...
    <div id="jobChoice">
      <div class="jobChoice">
        <div
          class="jobChoiceBox"
          :class="{ jobChoiceBox2: changeCNorEN == 'false' }"
        >
          <div>
          ...
          <div class="btn btn1">
            <span :class="{ active: show1 == null }" @click="column1(null)">{{
              choiceBtnCN.All
            }}</span>
            <span :class="{ active: show2 == null }" @click="column2(null)">{{
              choiceBtnCN.All
            }}</span>
            <span :class="{ active: show3 == null }" @click="column3(null)">{{
              choiceBtnCN.All
            }}</span>
          </div>
          <div class="btn btn2">
            <span :class="{ active: show1 == 1 }" @click="column1(1)">{{
              choiceBtnCN.Online
            }}</span>
            <span :class="{ active: show2 == 1 }" @click="column2(1)">{{
              choiceBtnCN.Preschool
            }}</span>
            <span :class="{ active: show3 == 1 }" @click="column3(1)">{{
              choiceBtnCN.TrainingCentre
            }}</span>
          </div>
          <div class="btn btn3">
            <span :class="{ active: show1 == 2 }" @click="column1(2)">{{
              choiceBtnCN.Offline
            }}</span>
            <span :class="{ active: show2 == 2 }" @click="column2(2)">{{
              choiceBtnCN.OtherCountries
            }}</span>
            <span :class="{ active: show3 == 2 }" @click="column3(2)">{{
              choiceBtnCN.PublicSchool
            }}</span>
          </div>
          <div class="btn btn4">
            <span></span>
            <span :class="{ active: show2 == 3 }" @click="column2(3)">{{
              choiceBtnCN.HighSchool
            }}</span>
            <span :class="{ active: show3 == 3 }" @click="column3(3)">{{
              choiceBtnCN.InternationalSchool
            }}</span>
          </div>
        </div>
      </div>
          ...
          <li v-for="item in allData" :key="item.orreId">
            <div class="userMsg" @click="goToJigouMessage(item.orreId)">
              <div>
                ...
                <p>
                  {{ Salary }}：¥{{ item.orreExpectedSalaryBottom }}-¥{{
