                ...
                <div class="rightContent">
                  ...
                  <div class="rContent">
                    <div>
                      ...
                      <div>
                        <span>{{mTitle.Nationality}}：{{userData.ftapCountry}}</span> 
                      </div>
                      <div>
                        <span>{{mTitle.CurrentLocation}}：{{userData.ftapCity}}</span> 
                      </div>
                      <div>
                        <span>{{mTitle.ChineseLevell}}：{{userData.ftapCheineseLevel}}</span> 
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="rightContent">
                  <div class="workPlace">
                    <div class="salary">
                      ...
                      <div>
                        <span class="money">{{userData.ftapExpectedSalaryBottom}} - {{userData.ftapExpectedSalaryTop}}</span>
                      </div>
                    </div>
                  </div>
                </div>
