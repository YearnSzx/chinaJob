        ...
        <div>
          <div class="usContent">
            <div class="usContentBox">
              ...
              <el-row>
                <el-col :span="24">
                  <div class="msgTitle">{{textTitle.PostingRecruitingInformation}}</div>
                </el-col>
              </el-row>
              ...
              <el-form ref="form" :model="form" :rules="rulesFn()">
                ...
                <el-form-item prop="WorkingLocation">
                  <div class="msgContentTitle1">{{textTitle.WorkingLocation}}</div>
                  <el-input v-model="form.WorkingLocation"></el-input>
                </el-form-item>
                <el-form-item prop="WorkingMode">
                  <div class="msgContentTitle1"> {{ textTitle.WorkingMode}} </div>
                ...
                <el-form-item>
                  <div class="msgContentTitle1">{{textTitle.SalaryRange}}</div>
                  <el-col :span="11">
                ...
                <el-form-item prop="Qualifications">
                  <div class="msgContentTitle1">{{textTitle.Qualifications}}</div>
                  <el-input 
                    type="textarea" 
                ...
                <el-form-item class="submitMessage">
                  <el-button type="primary" @click="submitForm('form')">{{textTitle.sub}}</el-button>
                </el-form-item>
