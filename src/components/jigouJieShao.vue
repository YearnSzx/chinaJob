  ...
  <div>
            ...
            <div class="mainBoxLeft">
              <div class="mLeftTop">
                <div>
                  ...
                  <p v-if="orreNameEn == 'false'">{{orreData.orreOrgNameEn}}</p>
                </div>
              </div>
                ...
                <div class="rightContent">
                  <div class="workPlace">
                    <div>
                      ...
                      <span class="money">{{orreData.orreExpectedSalaryBottom}} - {{orreData.orreExpectedSalaryTop}}</span>
                    </div>
                  </div>
                </div>
    ...
    <div class="wechat">
      <el-dialog
        ...
        <span v-if="weChatMsgNone">{{wechat.wechatMessage}}：{{GWData.userWechat}}</span>
    ...
    <div class="phone">
      <el-dialog
        ...
        <span v-if="phoneMsgNone">{{phone.phoneMessage}}：{{GWData.userPhone}}</span>
        <span v-if="phoneMsgNone" slot="footer" class="dialog-footer">
          <el-button 
            v-clipboard:copy="GWData.userPhone"
            v-clipboard:success="onCopy"
            v-clipboard:error="onError"
          @click="copy()">{{Copy}}</el-button>
        </span>
      </el-dialog>
    </div>
    ...
    <div class="whatapp">
      <el-dialog
        ...
        <span v-if="whatsAPPMsgNone">{{whatapp.whatappMessage}}：{{GWData.userWhatsapp}}</span>
    ...
    <div class="facebok">
      <el-dialog
        ...
        <span v-if="FaceBookMsgNone">{{faceBook.faceBookMessage}}：{{GWData.userFacebook}}</span>
