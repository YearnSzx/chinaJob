  ...
  <div id="forgotPw">
    <div class="forgotPw">
        ...
        <div class="form" :class="{form2:changeL == true}">
            <el-form :model="formData" label-width="115px" ref="formData" :rules="rules" label-position="left">
                <div class="must deepCss">
                    <el-form-item :label="formData2.PhoneNumber" prop="PhoneNumber">
                        <el-input v-model="formData.PhoneNumber" auto-complete="off" clearable></el-input>
                    </el-form-item>
                </div>
                 <div class="deepCss">
                    <el-form-item :label="formData2.VerificationCode"  prop="YanZhengMa" >
                        <el-input v-model="formData.YanZhengMa" auto-complete="off" maxlength="6" clearable >
                            ...
                            :disabled = phoneYZM 
                            @click="sendYzm" 
                            >{{formData2.getYzm}}<span v-if="waitHalfMin">({{secondsLeft}}s)</span></el-button>
                        </el-input>
                    </el-form-item>
                 </div>
                <div class="must deepCss">
                    <el-form-item :label="formData2.NewPassword"  prop="Password">
                        <el-input v-model="formData.PassWord" auto-complete="off" clearable></el-input>
                    </el-form-item>
                </div>
                <div class="must deepCss">
                    <el-form-item :label="formData2.ConfirmPassword"  prop="NewPassWord">
                        <el-input v-model="formData.NewPassword" auto-complete="off" clearable></el-input>
                    </el-form-item>
